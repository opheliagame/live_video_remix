defmodule LiveVideoRemix.Peer do
  @moduledoc false
  ...
  alias LiveVideoRemix.Room
  alias LiveVideoRemixWeb.PeerChannel
  ...
  def registry_id(id), do: {:via, Registry, {LiveVideoRemix.PeerRegistry, id}}

  @impl true
  def init([id, channel, peer_ids]) do
    Logger.debug("Starting new peer #{id}")
    # ice_port_range = Application.fetch_env!(:live_video_remix, :ice_port_range)
